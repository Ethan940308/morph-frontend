...
onMounted(async () => {
    ...
    await ContentService.show(Constant.getConstantValue('content_type', 'ABOUT_US')).then((response) => {
        if(response.data){
            ...
            <div class="py-6 px-6 mx-0 md:mx-12 lg:mx-20 lg:px-20 z-20">
                <div class="card px-6 py-20 md:px-12 lg:px-20">
                    ...
                    <div class="mt-4 md:mt-20">
                        <span class="block text-surface-900 dark:text-surface-0 font-bold text-3xl mb-4 text-center">Our
                            Team</span>
                        <div class="text-center text-lg leading-normal mb-12">Faucibus ornare suspendisse sed nisi. Nisl
                            rhoncus mattis rhoncus urna neque viverra justo nec.</div>
                                ...
                                <div class="relative overflow-hidden">
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col p-8 h-full">
                                            ...
                                            <span class="font-medium text-surface-400 dark:text-surface-400">Software
                                                Developer</span>
                                            <div class="mt-auto">
                                                <a tabindex="0" class="cursor-pointer text-white">
                                                    <i
                                                        class="pi pi-twitter text-surface-200 dark:text-surface-200 text-xl mr-4"></i>
                                                </a>
                                                <a tabindex="0" class="cursor-pointer text-white">
                                                    <i
                                                        class="pi pi-github text-surface-200 dark:text-surface-200 text-xl mr-4"></i>
                                                </a>
                                                <a tabindex="0" class="cursor-pointer text-white">
                                                    <i
                                                        class="pi pi-facebook text-surface-200 dark:text-surface-200 text-xl"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-span-12 md:col-span-6 lg:col-span-3 p-4">
                                <div class="relative overflow-hidden">
                                    ...
                                    <div
                                        ...
                                        :style="{ backgroundColor: 'rgba(0,0,0,0.7)' }">
                                        <div class="flex flex-col p-8 h-full">
                                            <span class="block font-medium text-white text-xl mb-4">Kristin
                                                Watson</span>
                                            <span class="font-medium text-surface-400 dark:text-surface-400">UI/UX
                                                Designer</span>
                                            <div class="mt-auto">
                                                <a tabindex="0" class="cursor-pointer text-white">
                                                    <i
                            ...
                            <div class="col-span-12 md:col-span-6 lg:col-span-3 p-4">
                                <div class="relative overflow-hidden">
                                    ...
                                    <div
                                        ...
                                        :style="{ backgroundColor: 'rgba(0,0,0,0.7)' }">
                                        <div class="flex flex-col p-8 h-full">
                                            <span class="block font-medium text-white text-xl mb-4">Jenna
                                                Williams</span>
                                            <span class="font-medium text-surface-400 dark:text-surface-400">Marketing
                                                Specialist</span>
                                            <div class="mt-auto">
                                                <a tabindex="0" class="cursor-pointer text-white">
                                                    <i
                                ...
                                <div class="relative overflow-hidden">
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col p-8 h-full">
                                            ...
                                            <span class="font-medium text-surface-400 dark:text-surface-400">Customer
                                                Relations</span>
                                            <div class="mt-auto">
                                                <a tabindex="0" class="cursor-pointer text-white">
                                                    <i
